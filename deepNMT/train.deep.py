...
from fairseq.trainer_deep import Trainer
...
def main(args):
    ...
    # put load_checkpoint after _build_optimizer(), then in load_checkpoint, there is no need to _build_optimizer
    load_checkpoint(args, trainer, epoch_itr)
...
if __name__ == '__main__':
    ...
    if args.distributed_port > 0 or args.distributed_init_method is not None:
        ...
        from multiprocessing_train_deep import main as multiprocessing_main
