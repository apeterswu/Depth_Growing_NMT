...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--display-freq', default=100, type=int, metavar='N')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--not-reload-aux', action='store_true',
                       help='whether reload the related aux variables')
